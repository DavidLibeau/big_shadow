...
Pebble.addEventListener('showConfiguration', function(e) {
  ...
  if ((platform=="basalt")||(platform=="chalk"))  {
    url="http://pebbleconfig.php5.cz/bigshadowpalette2.html?c1="+c1+"&c2="+c2+"&c3="+c3+"&c4="+c4+"&c5="+c5+"&c6="+c6;
  } else {
    url="http://pebbleconfig.php5.cz/bigshadowbw2.html?c1="+c1+"&c2="+c2+"&c3="+c3+"&c4="+c4+"&c5="+c5+"&c6="+c6;   
  }
   console.log(url);
   Pebble.openURL(url);
});
